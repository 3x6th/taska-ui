...
>
> Что здесь всё ещё авторитетно: `api-gateway-rest-draft.md` — верхний источник в порядке
> приоритета (см. `AGENTS.md`), и `Taska.dc.html` как эталон внешнего вида экранов.
>
