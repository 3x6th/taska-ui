...
**Re-measure this table, do not read it.** On 2026-09-08 the whole of it was
probed in one pass, and **three of the five open rows had been fixed by the
backend without anyone noticing** — including TAS-162, which this table
described as disabling the board's core gesture. The two that survived, TAS-137
and TAS-180, survived every clause. A blocker is a claim about a running system
