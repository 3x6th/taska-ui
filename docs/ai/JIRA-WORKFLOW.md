...
| [TAS-224](https://jira.ozero.dev/browse/TAS-224) | TAS-137 deployed: `HybridTaskaApi` stops synthesising the members and the role, `VITE_TASKA_ASSUME_PROJECT_ADMIN` goes, and the snapshot moves to develop `1cfe4d7` (PR #152 and PR #147) | In Progress | `feat/TAS-224-members-from-gateway`. Measured 2026-09-16 12:34 UTC without a token: `…/members` 401 (405 on 2026-09-12), `…/attachments` 401, `/users/me` 401. Blocked-by link from TAS-137, relates to TAS-209 and TAS-219 |
