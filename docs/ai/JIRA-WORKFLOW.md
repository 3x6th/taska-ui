...
| [TAS-219](https://jira.ozero.dev/browse/TAS-219) | The member read and `currentUserRole` from the gateway — the frontend half of TAS-137 (backend PR #152) | To Do | filed 2026-09-12, written against the pending contract `docs/contract/pending/pr-152-TAS-137.yml` while PR #152 is open |
